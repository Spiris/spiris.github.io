            ...
            ChangeTextures: function () {
                ...
                if (this.IsDrawingForDebug) {
                    ...
                    for (var i2 = 0; i2 < SirFlocksalot.Flock.NumFlock; i2 = (i2 + 1) | 0) {
                        ...
                        this.Agents.getItem(i2).DrawScale = 0.5;
